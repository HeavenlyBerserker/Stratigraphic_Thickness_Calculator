...
$backendBool = $(if ($mpl) { 'True' } else { 'False' })
...
if ($mpl) {
    Write-Host "Schematic backend: Matplotlib (--mpl); Qt WebEngine not bundled."
} else {
    Write-Host "Schematic backend: Qt WebEngine + embedded JS (default)."
}
